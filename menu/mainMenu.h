...
void menu(RenderWindow& window) {
	...
	menuTexture1.loadFromFile("otherData/textures/mainMenuText/START.png");
	menuTexture2.loadFromFile("otherData/textures/mainMenuText/EXIT.png");
	menuTexture3.loadFromFile("otherData/textures/mainMenuText/credits.png");
	menuBackground.loadFromFile("otherData/textures/mainMenuText/BG");
	aboutTexture.loadFromFile("otherData/textures/mainMenuText/about.png");
	...
	targetBuffer.loadFromFile("otherData/music/gameMenu/target.wav");
	Sound target(targetBuffer);

	pressBuffer.loadFromFile("otherData/music/gameMenu/press.wav");
	Sound press(pressBuffer);

	Music music;
	music.openFromFile("otherData/music/gameMenu/hiddenScroll.wav");
	music.play();
	music.setLoop(true);
